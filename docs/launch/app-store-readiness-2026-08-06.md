...
| Local RC successor | `hehaonline/heha-order-hub@0bc3cc09d6d3e58d477814521479465ad03ad8fc` (PR #232, stacked on #226; tested app head `3312c8495d3b4cebd16b0f29723411ade32a275e`, final commit evidence-only) | Review-only successor; cart and filtered-empty accessibility repairs evidenced, scheduling submission parked, and not launch-ready |
| Local customer recovery | `hehaonline/heha-order-hub@6036fb0714e95ec9aca0463deb29fab07fc0ec27` (PR #230, based on main) | Independent draft; hosted build gates green, focused Vitest and assistive-technology retry QA unexecuted |
...
- **PR #232** at evidence head `0bc3cc09d6d3e58d477814521479465ad03ad8fc` (tested app head `3312c8495d3b4cebd16b0f29723411ade32a275e`) is stacked on #226. It restores catalog navigation and 44px targets, removes the false Community Pass waitlist/contact claim, parks order submission because no truthful customer-selected scheduling flow exists, and repairs the reviewed cart-editing and filtered-empty recovery semantics/targets. The committed packet reports 69/69 contained browser checks, including cart controls, Market filtered-empty recovery, keyboard focus, and 200% zoom; that packet was inspected in review but not independently executed. It remains a review-only stacked successor—not an independently deployable or production-validated release.
...
- **PR #230** at `6036fb0714e95ec9aca0463deb29fab07fc0ec27` independently repairs customer order-history query/Realtime recovery from current main. GitHub Actions run #371, Vercel, and Snyk succeeded, but the workflow does not execute Vitest; authenticated Supabase and browser/accessibility recovery remain unproved. Its 40px retry and 36px catalog-fallback targets remain below the established 44px minimum. Retry also unmounts the focused alert/control into an unnamed spinner for up to 10 seconds, leaving keyboard and screen-reader users without perceivable in-progress feedback. It is not part of #226/#232.
