...
import { createScoutFollowupTask } from "./scoutTask";
...
function scoutTab({ id, label, filter, event = false, leadType }) {
  return {
    ...
    description: "Add what you know now. Fields are optional. Public HEHA Swipe visibility still requires Admin approval.",
    ...
    afterSave: createScoutFollowupTask,
