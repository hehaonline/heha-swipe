-- Minimal disposable PostgreSQL baseline for Community Pass Package A proof.
-- This is synthetic CI-only infrastructure, not a replacement for the canonical
-- Supabase migration lineage or current-schema clone replay.
...
values
  ('00000000-0000-0000-0000-0000000000a1', 'community-pass-a@example.invalid'),
  ('00000000-0000-0000-0000-0000000000b2', 'community-pass-b@example.invalid')
